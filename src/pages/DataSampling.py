...
st.markdown("""Uma amostragem estatística é uma distribuição probabilística, baseada na retirada de amostras, 
com um alto grau de aleatoriedade, e um tamanho fixo, na população pesquisada. Distribuições probabilísticas ajudam o 
pesquisador a entender como os resultados de amostra variam entre as amostras. Os métodos de amostragem são técnicas 
utilizadas para selecionar um subconjunto de unidades da população com o objetivo de realizar análises estatísticas 
ou pesquisas. 
([*FROST, Jim*](https://statisticsbyjim.com/hypothesis-testing/sampling-distribution/); 
[*HASSAN, Muhammad*](https://www.google.com/url?q=https://researchmethod.net/sampling-methods/&sa=D&source=docs&ust=1718890332471500&usg=AOvVaw3ln8LDCgAN8AYPLR1EEuHZ)).

---

E entre os tipos de amostragem estatística dispostos, foram escolhidas:

1. Amostragem aleatória simples (Amostragem Probabilística) - Todos os membros da população têm chances iguais de 
serem selecionados para a amostra. 
2. Amostragem proposital (Amostragem não probabilística) - Os participantes são 
selecionados com base em critérios específicos, como experiência ou conhecimento sobre um determinado tema.
